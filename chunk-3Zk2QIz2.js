...
`],encapsulation:2})}return n})();var Qt=(()=>{class n{static ɵfac=function(o){return new(o||n)};static ɵmod=mI({type:n});static ɵinj=dl({imports:[Ie,at,nt$1]})}return n})();var ft=`/assets/images/emotions/fish`;function Kt(n,a,t){return t!==`fish`?null:n===`emotions`?`${ft}/f_${a}.jpg`:null}function Zt(n){let a=[`emoji`];return n===`emotions`&&a.push(`fish`),a}function rt(n){let a=[...n];for(let t=a.length-1;t>0;t-=1){let o=Math.floor(Math.random()*(t+1));[a[t],a[o]]=[a[o],a[t]]}return a}function u(n){return n.toLowerCase().replace(/\s+/g,``).replace(/ё/g,`е`)}function T(n){return u(n).split(``)}function vt(n){return rt(T(n).map((a,t)=>({id:`${t}-${a}-${crypto.randomUUID()}`,letter:a})))}function _t(n){let a=T(n).length;return{word:n,slotDropData:Array.from({length:a},()=>[]),bank:vt(n)}}function te(n){return n.map(a=>_t(a))}function St(n,a){return u(n.map(o=>o?.letter??``).join(``))===u(a)}function kt(n){return n.slotDropData.length>0&&n.slotDropData.every(a=>a.length===1)}function yt(n){return St(n.slotDropData.map(t=>t[0]??null),n.word)}function ee(n){return n.length>0&&n.every(kt)}function ne(n){return n.length>0&&n.every(yt)}function xt(n){return`bank-${n}`}function Nt(n,a){return`slot-${n}-${a}`}function oe(n){if(n.startsWith(`bank-`))return{kind:`bank`,blockIndex:Number(n.replace(`bank-`,``))};if(n.startsWith(`slot-`)){let[,a,t]=n.split(`-`);return{kind:`slot`,blockIndex:Number(a),slotIndex:Number(t)}}return null}function It(n,a){let t=n.slotDropData[a]?.[0];if(!t)return!1;let o=T(n.word)[a];return o?u(t.letter)===u(o):!1}function ae(n,a){return n.slotDropData[a]?.[0]?!It(n,a):!1}function re(n,a){return[xt(a),...n.slotDropData.map((t,o)=>Nt(a,o))]}export{xt as _,T as a,at as c,ne as d,oe as f,u as g,te as h,Qt as i,ee as l,rt as m,Kt as n,Zt as o,re as p,Nt as r,ae as s,It as t,ht as u};