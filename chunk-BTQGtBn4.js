...
`],encapsulation:2})}return a})();var Ht=(()=>{class a{static ɵfac=function(n){return new(n||a)};static ɵmod=TI({type:a});static ɵinj=fl({imports:[$e,at,ft$1]})}return a})();var _t={а:`а`,б:`бэ`,в:`вэ`,г:`гэ`,д:`дэ`,е:`е`,ё:`ё`,ж:`жэ`,з:`зэ`,и:`и`,й:`и краткое`,к:`ка`,л:`эль`,м:`эм`,н:`эн`,о:`о`,п:`пэ`,р:`эр`,с:`эс`,т:`тэ`,у:`у`,ф:`эф`,х:`ха`,ц:`цэ`,ч:`че`,ш:`ша`,щ:`ща`,ъ:`твёрдый знак`,ы:`ы`,ь:`мягкий знак`,э:`э`,ю:`ю`,я:`я`};function it(a){let o=a.trim().toLowerCase();return o?o.length===1?_t[o]??o:o:null}var St=`assets/sounds/correct.wav`;var yt=`assets/sounds/incorrect.wav`;var kt=80;var rt=class a{settingsService=T(u);correctAudio=null;incorrectAudio=null;voices=[];speakTimer=null;unlocked=!1;constructor(){this.initSpeech()}playCorrect(){this.play(this.getAudio(St,`correct`))}playIncorrect(){this.play(this.getAudio(yt,`incorrect`))}speakLetter(o){let t=it(o);t&&this.speak(t,{rate:.95,interrupt:!0})}speakWord(o,t){let n=o.trim();n&&this.speak(n,{rate:.85,interrupt:t?.interrupt??!0,delayMs:t?.delayMs})}initSpeech(){if(typeof window>`u`||!window.speechSynthesis)return;let o=()=>{this.voices=window.speechSynthesis.getVoices()};o(),window.speechSynthesis.addEventListener(`voiceschanged`,o);let t=()=>{this.unlockSpeech(),window.removeEventListener(`pointerdown`,t,!0),window.removeEventListener(`keydown`,t,!0)};window.addEventListener(`pointerdown`,t,!0),window.addEventListener(`keydown`,t,!0)}unlockSpeech(){if(this.unlocked||typeof window>`u`||!window.speechSynthesis)return;this.unlocked=!0,window.speechSynthesis.getVoices();let o=new SpeechSynthesisUtterance(` `);o.volume=0,o.rate=1,o.lang=`ru-RU`,window.speechSynthesis.speak(o)}speak(o,t){if(!this.settingsService.settings().soundEnabled||typeof window>`u`||!window.speechSynthesis)return;this.unlockSpeech();let n=()=>{let e=new SpeechSynthesisUtterance(o);e.lang=`ru-RU`,e.rate=t.rate;let i=this.pickRussianVoice();i&&(e.voice=i);let r=()=>{window.speechSynthesis.speak(e),window.speechSynthesis.resume()},d=window.speechSynthesis;if(t.interrupt&&(d.speaking||d.pending)){d.cancel(),this.clearSpeakTimer(),this.speakTimer=setTimeout(r,kt);return}r()};if(t.delayMs&&t.delayMs>0){this.clearSpeakTimer(),this.speakTimer=setTimeout(n,t.delayMs);return}n()}pickRussianVoice(){if(typeof window>`u`||!window.speechSynthesis)return;let o=this.voices.length?this.voices:window.speechSynthesis.getVoices();return this.voices=o,o.find(t=>/^ru\b/i.test(t.lang)&&t.localService)??o.find(t=>/^ru\b/i.test(t.lang))}clearSpeakTimer(){this.speakTimer&&(clearTimeout(this.speakTimer),this.speakTimer=null)}getAudio(o,t){return t===`correct`?(this.correctAudio??=new Audio(o),this.correctAudio):(this.incorrectAudio??=new Audio(o),this.incorrectAudio)}play(o){this.settingsService.settings().soundEnabled&&(o.currentTime=0,o.play().catch(()=>{}))}static ɵfac=function(t){return new(t||a)};static ɵprov=se({token:a,factory:a.ɵfac,providedIn:`root`})};function Jt(a){let o=[...a];for(let t=o.length-1;t>0;t-=1){let n=Math.floor(Math.random()*(t+1));[o[t],o[n]]=[o[n],o[t]]}return o}export{vt as a,rt as i,Jt as n,at as r,Ht as t};