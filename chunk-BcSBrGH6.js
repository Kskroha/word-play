...
`],encapsulation:2})}return o})();var zt=(()=>{class o{static ɵfac=function(n){return new(n||o)};static ɵmod=TI({type:o});static ɵinj=fl({imports:[$e,at,ft$1]})}return o})();var vt=`assets/sounds/correct.wav`;var _t=`assets/sounds/incorrect.wav`;var it=class o{settingsService=T(u);correctAudio=null;incorrectAudio=null;playCorrect(){this.play(this.getAudio(vt,`correct`))}playIncorrect(){this.play(this.getAudio(_t,`incorrect`))}getAudio(i,t){return t===`correct`?(this.correctAudio??=new Audio(i),this.correctAudio):(this.incorrectAudio??=new Audio(i),this.incorrectAudio)}play(i){this.settingsService.settings().soundEnabled&&(i.currentTime=0,i.play().catch(()=>{}))}static ɵfac=function(t){return new(t||o)};static ɵprov=se({token:o,factory:o.ɵfac,providedIn:`root`})};function Wt(o){let i=[...o];for(let t=i.length-1;t>0;t-=1){let n=Math.floor(Math.random()*(t+1));[i[t],i[n]]=[i[n],i[t]]}return i}export{zt as a,it as i,at as n,ft as r,Wt as t};