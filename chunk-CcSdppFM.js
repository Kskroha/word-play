import{At as dl,Bt as hP,D as Fy,E as Fe,En as x,F as JI,Ft as fr,Kt as jI,On as xo,Rt as gI,T as FI,Xt as lp,Z as Qf,Zt as mP,_n as tp,_t as Zf,bt as ao,dn as rp,dt as XI,en as nE,gn as tE,ht as Yf,kn as yI,nn as oE,pt as YI,q as OE,rn as oi,tn as np,tt as T,wt as bp,x as EI,yn as uc}from"./main-WCMFXCJI.js";import{C as pe,O as xe,S as nt$1,a as Ie,g as _a,i as H,l as L,p as Qe,u as Nt,y as gt$1}from"./chunk-tAm_zGME.js";import{a as Pe,c as fe,i as En}from"./chunk-BvJvpTKC.js";var gt=[`button`];var dt=[`*`];function ct(o,s){if(o&1&&(oi(0,`div`,2),Yf(1,`mat-pseudo-checkbox`,6),uc()),o&2){let t=YI();Fy(),Zf(`disabled`,t.disabled)}}var tt=new x(`MAT_BUTTON_TOGGLE_DEFAULT_OPTIONS`,{providedIn:`root`,factory:()=>({hideSingleSelectionIndicator:!1,hideMultipleSelectionIndicator:!1,disabledInteractive:!1})});var et=new x(`MatButtonToggleGroup`);var ut={provide:Pe,useExisting:ao(()=>bt),multi:!0};var h=class{source;value;constructor(s,t){this.source=s,this.value=t}};var bt=(()=>{class o{_changeDetector=T(hP);_dir=T(Qe,{optional:!0});_multiple=!1;_disabled=!1;_disabledInteractive=!1;_selectionModel;_rawValue;_controlValueAccessorChangeFn=()=>{};_onTouched=()=>{};_buttonToggles;appearance;get name(){return this._name}set name(t){this._name=t,this._markButtonsForCheck()}_name=T(Nt).getId(`mat-button-toggle-group-`);vertical=!1;get value(){let t=this._selectionModel?this._selectionModel.selected:[];return this.multiple?t.map(n=>n.value):t[0]?t[0].value:void 0}set value(t){this._setSelectionByValue(t),this.valueChange.emit(this.value)}valueChange=new Fe;get selected(){let t=this._selectionModel?this._selectionModel.selected:[];return this.multiple?t:t[0]||null}get multiple(){return this._multiple}set multiple(t){this._multiple=t,this._markButtonsForCheck()}get disabled(){return this._disabled}set disabled(t){this._disabled=t,this._markButtonsForCheck()}get disabledInteractive(){return this._disabledInteractive}set disabledInteractive(t){this._disabledInteractive=t,this._markButtonsForCheck()}get dir(){return this._dir&&this._dir.value===`rtl`?`rtl`:`ltr`}change=new Fe;get hideSingleSelectionIndicator(){return this._hideSingleSelectionIndicator}set hideSingleSelectionIndicator(t){this._hideSingleSelectionIndicator=t,this._markButtonsForCheck()}_hideSingleSelectionIndicator;get hideMultipleSelectionIndicator(){return this._hideMultipleSelectionIndicator}set hideMultipleSelectionIndicator(t){this._hideMultipleSelectionIndicator=t,this._markButtonsForCheck()}_hideMultipleSelectionIndicator;constructor(){let t=T(tt,{optional:!0});this.appearance=t&&t.appearance?t.appearance:`standard`,this._hideSingleSelectionIndicator=t?.hideSingleSelectionIndicator??!1,this._hideMultipleSelectionIndicator=t?.hideMultipleSelectionIndicator??!1}ngOnInit(){this._selectionModel=new fe(this.multiple,void 0,!1)}ngAfterContentInit(){this._selectionModel.select(...this._buttonToggles.filter(t=>t.checked)),this.multiple||this._initializeTabIndex()}writeValue(t){this.value=t,this._changeDetector.markForCheck()}registerOnChange(t){this._controlValueAccessorChangeFn=t}registerOnTouched(t){this._onTouched=t}setDisabledState(t){this.disabled=t}_keydown(t){if(this.multiple||this.disabled||pe(t))return;let e=t.target.id,a=this._buttonToggles.toArray().findIndex(g=>g.buttonId===e),l=null;switch(t.keyCode){case 32:case 13:l=this._buttonToggles.get(a)||null;break;case 38:l=this._getNextButton(a,-1);break;case 37:l=this._getNextButton(a,this.dir===`ltr`?-1:1);break;case 40:l=this._getNextButton(a,1);break;case 39:l=this._getNextButton(a,this.dir===`ltr`?1:-1);break;default:return}l&&(t.preventDefault(),l._onButtonClick(),l.focus())}_emitChangeEvent(t){let n=new h(t,this.value);this._rawValue=n.value,this._controlValueAccessorChangeFn(n.value),this.change.emit(n)}_syncButtonToggle(t,n,e=!1,a=!1){!this.multiple&&this.selected&&!t.checked&&(this.selected.checked=!1),this._selectionModel?n?this._selectionModel.select(t):this._selectionModel.deselect(t):a=!0,a?Promise.resolve().then(()=>this._updateModelValue(t,e)):this._updateModelValue(t,e)}_isSelected(t){return this._selectionModel&&this._selectionModel.isSelected(t)}_isPrechecked(t){return typeof this._rawValue>`u`?!1:this.multiple&&Array.isArray(this._rawValue)?this._rawValue.some(n=>t.value!=null&&n===t.value):t.value===this._rawValue}_initializeTabIndex(){if(this._buttonToggles.forEach(t=>{t.tabIndex=-1}),this.selected)this.selected.tabIndex=0;else for(let t=0;t<this._buttonToggles.length;t++){let n=this._buttonToggles.get(t);if(!n.disabled){n.tabIndex=0;break}}}_getNextButton(t,n){let e=this._buttonToggles;for(let a=1;a<=e.length;a++){let l=(t+n*a+e.length)%e.length,g=e.get(l);if(g&&!g.disabled)return g}return null}_setSelectionByValue(t){if(this._rawValue=t,!this._buttonToggles)return;let n=this._buttonToggles.toArray();if(this.multiple&&t?(this._clearSelection(),t.forEach(e=>this._selectValue(e,n))):(this._clearSelection(),this._selectValue(t,n)),!this.multiple&&n.every(e=>e.tabIndex===-1)){for(let e of n)if(!e.disabled){e.tabIndex=0;break}}}_clearSelection(){this._selectionModel.clear(),this._buttonToggles.forEach(t=>{t.checked=!1,this.multiple||(t.tabIndex=-1)})}_selectValue(t,n){for(let e of n)if(e.value===t){e.checked=!0,this._selectionModel.select(e),this.multiple||(e.tabIndex=0);break}}_updateModelValue(t,n){n&&this._emitChangeEvent(t),this.valueChange.emit(this.value)}_markButtonsForCheck(){this._buttonToggles?.forEach(t=>t._markForCheck())}static ɵfac=function(n){return new(n||o)};static ɵdir=EI({type:o,selectors:[[`mat-button-toggle-group`]],contentQueries:function(n,e,a){if(n&1&&np(a,nt,5),n&2){let l;tE(l=nE())&&(e._buttonToggles=l)}},hostAttrs:[1,`mat-button-toggle-group`],hostVars:6,hostBindings:function(n,e){n&1&&tp(`keydown`,function(l){return e._keydown(l)}),n&2&&(Qf(`role`,e.multiple?`group`:`radiogroup`)(`aria-disabled`,e.disabled),lp(`mat-button-toggle-vertical`,e.vertical)(`mat-button-toggle-group-appearance-standard`,e.appearance===`standard`))},inputs:{appearance:`appearance`,name:`name`,vertical:[2,`vertical`,`vertical`,mP],value:`value`,multiple:[2,`multiple`,`multiple`,mP],disabled:[2,`disabled`,`disabled`,mP],disabledInteractive:[2,`disabledInteractive`,`disabledInteractive`,mP],hideSingleSelectionIndicator:[2,`hideSingleSelectionIndicator`,`hideSingleSelectionIndicator`,mP],hideMultipleSelectionIndicator:[2,`hideMultipleSelectionIndicator`,`hideMultipleSelectionIndicator`,mP]},outputs:{valueChange:`valueChange`,change:`change`},exportAs:[`matButtonToggleGroup`],features:[OE([ut,{provide:et,useExisting:o}])]})}return o})();var nt=(()=>{class o{_changeDetectorRef=T(hP);_elementRef=T(fr);_focusMonitor=T(gt$1);_idGenerator=T(Nt);_animationDisabled=L();_checked=!1;ariaLabel;ariaLabelledby=null;_buttonElement;buttonToggleGroup;get buttonId(){return`${this.id}-button`}id;name;value;get tabIndex(){return this._tabIndex()}set tabIndex(t){this._tabIndex.set(t)}_tabIndex;disableRipple=!1;get appearance(){return this.buttonToggleGroup?this.buttonToggleGroup.appearance:this._appearance}set appearance(t){this._appearance=t}_appearance;get checked(){return this.buttonToggleGroup?this.buttonToggleGroup._isSelected(this):this._checked}set checked(t){t!==this._checked&&(this._checked=t,this.buttonToggleGroup&&this.buttonToggleGroup._syncButtonToggle(this,this._checked),this._changeDetectorRef.markForCheck())}get disabled(){return this._disabled||this.buttonToggleGroup&&this.buttonToggleGroup.disabled}set disabled(t){this._disabled=t}_disabled=!1;get disabledInteractive(){return this._disabledInteractive||this.buttonToggleGroup!==null&&this.buttonToggleGroup.disabledInteractive}set disabledInteractive(t){this._disabledInteractive=t}_disabledInteractive;change=new Fe;constructor(){T(H).load(xe);let t=T(et,{optional:!0}),n=T(new bp(`tabindex`),{optional:!0})||``,e=T(tt,{optional:!0});this._tabIndex=xo(parseInt(n)||0),this.buttonToggleGroup=t,this._appearance=e&&e.appearance?e.appearance:`standard`,this._disabledInteractive=e?.disabledInteractive??!1}ngOnInit(){let t=this.buttonToggleGroup;this.id=this.id||this._idGenerator.getId(`mat-button-toggle-`),t&&(t._isPrechecked(this)?this.checked=!0:t._isSelected(this)!==this._checked&&t._syncButtonToggle(this,this._checked))}ngAfterViewInit(){this._animationDisabled||this._elementRef.nativeElement.classList.add(`mat-button-toggle-animations-enabled`),this._focusMonitor.monitor(this._elementRef,!0)}ngOnDestroy(){let t=this.buttonToggleGroup;this._focusMonitor.stopMonitoring(this._elementRef),t&&t._isSelected(this)&&t._syncButtonToggle(this,!1,!1,!0)}focus(t){this._buttonElement.nativeElement.focus(t)}_onButtonClick(){if(this.disabled)return;let t=this.isSingleSelector()?!0:!this._checked;if(t!==this._checked&&(this._checked=t,this.buttonToggleGroup&&(this.buttonToggleGroup._syncButtonToggle(this,this._checked,!0),this.buttonToggleGroup._onTouched())),this.isSingleSelector()){let n=this.buttonToggleGroup._buttonToggles.find(e=>e.tabIndex===0);n&&(n.tabIndex=-1),this.tabIndex=0}this.change.emit(new h(this,this.value))}_markForCheck(){this._changeDetectorRef.markForCheck()}_getButtonName(){return this.isSingleSelector()?this.buttonToggleGroup.name:this.name||null}isSingleSelector(){return this.buttonToggleGroup&&!this.buttonToggleGroup.multiple}static ɵfac=function(n){return new(n||o)};static ɵcmp=gI({type:o,selectors:[[`mat-button-toggle`]],viewQuery:function(n,e){if(n&1&&rp(gt,5),n&2){let a;tE(a=nE())&&(e._buttonElement=a.first)}},hostAttrs:[`role`,`presentation`,1,`mat-button-toggle`],hostVars:14,hostBindings:function(n,e){n&1&&tp(`focus`,function(){return e.focus()}),n&2&&(Qf(`aria-label`,null)(`aria-labelledby`,null)(`id`,e.id)(`name`,null),lp(`mat-button-toggle-standalone`,!e.buttonToggleGroup)(`mat-button-toggle-checked`,e.checked)(`mat-button-toggle-disabled`,e.disabled)(`mat-button-toggle-disabled-interactive`,e.disabledInteractive)(`mat-button-toggle-appearance-standard`,e.appearance===`standard`))},inputs:{ariaLabel:[0,`aria-label`,`ariaLabel`],ariaLabelledby:[0,`aria-labelledby`,`ariaLabelledby`],id:`id`,name:`name`,value:`value`,tabIndex:`tabIndex`,disableRipple:[2,`disableRipple`,`disableRipple`,mP],appearance:`appearance`,checked:[2,`checked`,`checked`,mP],disabled:[2,`disabled`,`disabled`,mP],disabledInteractive:[2,`disabledInteractive`,`disabledInteractive`,mP]},outputs:{change:`change`},exportAs:[`matButtonToggle`],ngContentSelectors:dt,decls:7,vars:13,consts:[[`button`,``],[`type`,`button`,1,`mat-button-toggle-button`,`mat-focus-indicator`,3,`click`,`id`,`disabled`],[1,`mat-button-toggle-checkbox-wrapper`],[1,`mat-button-toggle-label-content`],[1,`mat-button-toggle-focus-overlay`],[`matRipple`,``,1,`mat-button-toggle-ripple`,3,`matRippleTrigger`,`matRippleDisabled`],[`state`,`checked`,`aria-hidden`,`true`,`appearance`,`minimal`,3,`disabled`]],template:function(n,e){if(n&1&&(JI(),oi(0,`button`,1,0),tp(`click`,function(){return e._onButtonClick()}),FI(2,ct,2,1,`div`,2),oi(3,`span`,3),XI(4),uc()(),Yf(5,`span`,4)(6,`span`,5)),n&2){let a=oE(1);Zf(`id`,e.buttonId)(`disabled`,e.disabled&&!e.disabledInteractive||null),Qf(`role`,e.isSingleSelector()?`radio`:`button`)(`tabindex`,e.disabled&&!e.disabledInteractive?-1:e.tabIndex)(`aria-pressed`,e.isSingleSelector()?null:e.checked)(`aria-checked`,e.isSingleSelector()?e.checked:null)(`name`,e._getButtonName())(`aria-label`,e.ariaLabel)(`aria-labelledby`,e.ariaLabelledby)(`aria-disabled`,e.disabled&&e.disabledInteractive?`true`:null),Fy(2),jI(e.buttonToggleGroup&&(!e.buttonToggleGroup.multiple&&!e.buttonToggleGroup.hideSingleSelectionIndicator||e.buttonToggleGroup.multiple&&!e.buttonToggleGroup.hideMultipleSelectionIndicator)?2:-1),Fy(4),Zf(`matRippleTrigger`,a)(`matRippleDisabled`,e.disableRipple||e.disabled)}},dependencies:[_a,En],styles:[`.mat-button-toggle-standalone,
...
`],encapsulation:2})}return o})();var Dt=(()=>{class o{static ɵfac=function(n){return new(n||o)};static ɵmod=yI({type:o});static ɵinj=dl({imports:[Ie,nt,nt$1]})}return o})();function Vt(o){let s=[...o];for(let t=s.length-1;t>0;t-=1){let n=Math.floor(Math.random()*(t+1));[s[t],s[n]]=[s[n],s[t]]}return s}export{nt as i,Vt as n,bt as r,Dt as t};